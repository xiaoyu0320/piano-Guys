...
export function getrechargeaddress (obj) {
  return gett('asc/getrechargeaddress', obj)
}
export function getasc2power (obj) {
  return gett('asc/asc2power', obj)
}
// 矿机商城
export const minelist = data => {
  return get('Ascmine/goodsList', data)
}
// 矿机详情
export const mineDetail = data => {
  return get('Ascmine/goodsDetail', data)
}
// 我的矿机
export const getMylease = data => {
  return get('Ascmine/myLease', data)
}
// 收益记录
export const profit = data => {
  return get('Ascmine/profitLogList', data)
}
// 矿场首页
export const mineIndex = data => {
  return get('Ascmine/index',data)
}
// 立即租赁
export const lease = data => {
  return get('Ascmine/lease', data)
}
// 矿池资产
export const getMineCoin = data => {
  return get('Ascmine/getMineCoin', data)
}
// transferToAsc
export const transferToAsc = data => {
  return get('Ascmine/transferToAsc', data)
} 
// mineLogList
export const mineLogList = data => {
  return get('Ascmine/mineLogList', data)
}
