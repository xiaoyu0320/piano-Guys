  ...
  <div class="exchangeETH fixed-top">
    ...
    <div v-if="showdiv" >
        ...
        <van-row style="padding:25px">
          <van-col span="8">
           <div class="login-item">
              ...
              <img data-v-5fe228f6="" v-if="title== 'ASC'" src="https://img.ttex.com/c29389d3e004e3cd45c3eceea6c692cf" width="30px">
          ...
          <van-col span="8">
            <div class="login-item">
              ...
              <img data-v-5fe228f6="" v-if="title2== 'ASC'" src="https://img.ttex.com/c29389d3e004e3cd45c3eceea6c692cf" width="30px">
      ...
      <van-row class="exchange-box">
       ...
       <van-col span="8" >
       <van-button  @click.native="changeConfirm()" size="small" class="linear-button"  disabled>暂未开放</van-button>
       </van-col>
      </van-row>
    <!-- <van-row class="exchange-wanning">
        <van-col span="8">24H 量  {{ascInfo.sum}}</van-col>
        <van-col span="12" offset="4">最新兑换<br>{{lastTrans}}</van-col>
      </van-row>
      -->
        </div>
    <div class="hue"></div>
    ...
    <van-row class="manage-box">
      <van-col span="24">
        ...
        <span class="catesapn" style="float:right;font-size:12px"> 
            ...
            <span><i class="circle " style="background:orange"></i>基石</span></span>
         </van-col>
      </van-col>
    </van-row>
...
export default {
  ...
  methods: {
    ...
    eosChangeClick(val){
      ...
      this.ascChange = Number(val.data)*(this.Getethusdt*this.Getusdtprice/this.Getascprice).toFixed(4)

      
    },
    ascChangeClick(val){
       console.log(this.changeRate,val.data)
      // this.eosChange = (Number(val.data) * this.changeRate).toFixed(4)
