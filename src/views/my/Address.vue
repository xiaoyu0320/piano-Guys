...
/>
 <div class="address-list" v-if="list.length>0">
    ...
    <div class="change__add">
        <van-button type="info" size="large" @click="ress">{{$t("message.addAddress")}}</van-button>
    </div>
   </div>
   <div class="addA "  v-else >
    ...
    <van-popup v-model="show">
       ...
       <div class="change-box">
        ...
        <div class="change-info">{{$t("message.name")}}</div>
        <div class="chage-input"><input type="text" v-model="addressName" :placeholder="$t('message.Pleaseaddress')"></div>
        <div class="change-info">{{$t("message.Accountaddress")}}</div>
        <div class="chage-input"><input type="text"  v-model="address" :placeholder="$t('message.Pleaseenter')"></div>
        <div class="change-btn">
              <van-button type="info" @click="submit()" size='small'>{{$t("message.Confirm")}}</van-button>
        </div>
       </div>
    </van-popup>
 </div>
