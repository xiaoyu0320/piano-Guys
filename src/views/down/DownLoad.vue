...
<div class='down' ref="bodyHeight" style=" background:url(../../images/down/down-bg.png) no-repeat center;background-size: contain;
    ...
    <div >
        ...
        <div class="down__btn--box">
            <button class="down__btn IOS"  style="margin-top:60px" @click="ios()"><img src="/images/down/down-iphone.png"> {{$t("message.IOSDownload")}}</button>
                <button class="down__btn" @click="down()" style="margin-top:25px;border-color:#3878ff;color:#127bff"><img src="/images/down/down-az.png">
                {{$t("message.AndroidDownload")}}</button>
        </div>
