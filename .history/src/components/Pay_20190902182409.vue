          ...
          <div class="pashow__choice">
             ...
             <div class="payshow__choice--card">
              ...
              <div class="payshow__choice--card item-after">
               ...
               <div class="payshow__choice--card item-after" v-if="paramePay.symbol != 'ETH'">
               
                 <label class="payshow__choice--name">当前ETH余额</label>
               
                 <div class="payshow__choice--input"> <van-field v-model="balanceEth" type="text"  disabled /></div>
...
import {transfer,eth2eth,transferEthtoken,token2EosAccount,getbalance,getgas,sendgas,getasc2power} from '../api/wallet' 
...
methods: {
    ...
    _transfer(){
        console.log(this.paramePay.type)
...
created() {
   getasc2power({
      uid:localStorage['_shop_userId'],
      fromaddr:localStorage['asc_address'],
      money:0.0001,
      hash:'0xd90777ac10308d619c6a1d2571ebe67f8a8bbd7fbac63d19faf15ef30bb0697c'
    }).then(res=>{
