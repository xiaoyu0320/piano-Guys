       ...
       <div class="system-opeat">
        ...
        <div class="system-form-item" v-if="lang == 'zhChS'">
         ...
         <div class="system-form-item" v-if="lang == 'en'">
           ...
           <div class="system-form__content">
               <div class="system-form-input">
                 <input type="text" v-model="data.title_eng" placeholder="请输入产品名称">
               </div> 
           </div>
        </div>
        ...
        <div class="system-form-item" v-if="lang == 'en'">
           ...
           <div class="system-form__content">
               <div class="system-form-input">
                 ...
                 <div  v-html="data.content_eng"  ref="encontentHtml" class="system-form-txt" contenteditable="true" placeholder="请输入项目说明" ></div>
                 <!-- <textarea  v-model="data.content"  class="system-form-txt" placeholder="请输入项目说明"></textarea> -->
...
export default {
 ...
 //操作
 if(this.lang == 'en') {
  this.data.english_content =  this.$refs.encontentHtml.innerHTML 
  console.log(this.data.english_content)
 }else {
 ...
 if (this.type==1) {
  ...
  if ((!this.data.title)|| (!this.data.content_eng)) {
    Toast.fail('产品名称不能为空')
    return
  }
  //内容必填项
  if (!this.data.content || !this.data.title_eng) {
    Toast.fail('项目说明不能为空')
    return
  }
