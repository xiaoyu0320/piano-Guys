          ...
          <van-pull-refresh v-model="isLoading" @refresh="onRefresh">
                 ...
                 <div class="list-cell-wrap" v-for="(item,i) in list" :key="i">
                    ...
                    <div class="list-cell">
                      <van-cell-group v-for="(child,index) in item.children" :key="index">
                        ...
                        <van-field v-model="item[child]"  :label="child"  @input="edit(item)" :disabled="child !='text'"/>
                      </van-cell-group>  
           ...
           <van-popup v-model="editText" :style="{ width: '80%' }">
             <div style="padding:20px">
                ...
                <van-button type="info" size="small" style="margin-left:10px;margin-bottom:10x" >编辑</van-button>
             </div>
