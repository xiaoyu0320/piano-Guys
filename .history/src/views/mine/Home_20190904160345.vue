<template>
  <div class="home">
    <img class="img" src="https://s2.j10kb.cn/uploads/20190904/d4a7ca1692f9ea72f49201578d3116a2.gif"  alt="" >
    ...
    <img class="sum" src="/images/minefield/sum.png" alt="">
    <div class="info">
