...
<div class='pool'>
    ...
    <div class="_pool">
      ...
      <div class="coins">
        ...
        <div class="item">
          <van-field v-model="value"  placeholder="请输入兑换数量" @input="change" type="number" />
          <div class="ex">
            <span>算力</span>
      ...
      <van-button class="button"  size="large" round @click="exchange" :disabled="clickFlag">立即兑换</van-button>
    </div>
</div>
</template>
