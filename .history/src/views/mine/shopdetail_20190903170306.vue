        ...
        <div class="bottom">
          <div class="left">
            ...
            <div class="total">总价: <font style="color:red">≈{{total}}ASC</font></div>
             <div class="total">每人限购数:<font style="color:red" :v-if="info.limit_qty">{{info.limit_qty}}</font></div>
              <div class="total">矿机总数:<font style="color:red" :v-if="info.limit_qty">{{info.limit_qty}}</font></div>
          </div>
          <div class="right">
