    ...
    <div v-if="showdiv" >
      <div class="login-tab">
        <van-row style="padding:25px;display:flex;align-items: center;">
          <van-col span="8">
           <div><img src="/images/minefield/coin.png" width="40px"></div>
           <div>链上资产</div>
...
import { asc2eth,getSaveList,transfer,getmarket,getcurrency,getethusdt,getusdtprice,getascprice,getethcusdt,getbtcusdt,getwtdusdt,geteosusdt,getwtcusdt,getrechargeaddress } from '@/api/wallet'
