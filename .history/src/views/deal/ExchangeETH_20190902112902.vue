        ...
        <van-row style="padding:25px;display:flex;align-items: center;">
          <van-col span="8">
           ...
           <div class="login-item">
                <input v-model="eosChange" type="number" class="login-input--style" @input="eosChangeClick" placeholder ="链上资产" />
           </div>
          </van-col>
          ...
          <van-col span="8">
            ...
            <div class="login-item">  
                <input  v-model="ascChange" type="number"   @input="ascChangeClick" class="login-input--style"  placeholder="兑换asc" />
           </div>
          </van-col>
        </van-row>
      </div>
