<template>
  <div class="walletmanage fixed-top"  v-if="EosAccount!=''">
    ...
    <div class="top">
      ...
      <div class="balance-detail">      
        <span>{{$t('message.Stake')}}</span>
        <label>{{accountInfo.total_resources.net_weight}}</label>
       </div>
      <div class="balance-detail">      
        <span>{{$t('message.Unstake')}}</span>
      ...
      <div class="list">
        ...
        <p>
          <van-button plain hairline size="small" @click="buttonClick()" type="primary">买入</van-button>
          <van-button plain hairline size="small" @click="buttonClick()"  type="primary">卖出</van-button>
        </p>
        </div>
         <div class="cpu">
        <span>CPU</span>
        ...
        <label>{{accountInfo.cpu_limit.used}} / {{accountInfo.cpu_limit.max}}</label>
         <van-button plain hairline size="small"  @click="buttonClick()"  type="primary">CPU租赁</van-button>
         </div>
          <div class="net">
         <span>NET</span>
         ...
         <p>
          <van-button plain hairline size="small" @click="buttonClick()"  type="primary">抵押</van-button>
           <van-button plain hairline size="small"  @click="buttonClick()"  type="primary">赎回</van-button>
         </p>
       </div>
