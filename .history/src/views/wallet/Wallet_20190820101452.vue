<template>
  <div class="assetsmanage  fixed-top">
    ...
    <div class="money">
      <van-row>
      <van-col span="4" @click.native="window.testjs.getIdentity('123')">资产 </van-col>
    ...
    <!--<li>
      ...
      <van-action-sheet v-model="show"  title="请选择钱包"  @cancel="onlead"  >
          <h5 class="wallet--title"><van-icon name="gold-coin-o" /> 默认的钱包</h5>
          ...
          <h5 class="wallet--title"><van-icon name="bill-o" />  导入的钱包</h5>
         ...
         <div class="qrcode">
          <div class="qrcode-box linear-button"> 
           ...
           <p  style="    word-wrap: break-word;">{{mygold[0].gold_address}} </p>
            ...
            <van-button type="info"   size="large" class="copybutton copybutton2"  @click.stop="getCopy(2)"  :data-clipboard-text="mygold[0].gold_address">复制</van-button>
         </div>
     </van-popup>
