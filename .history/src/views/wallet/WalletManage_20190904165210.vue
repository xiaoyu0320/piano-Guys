      ...
      <div class="list" v-if="showList" >
       ...
       <div class="delWallet">
        ...
        <div style="padding:20px">
          ...
          <div class="import-title"><img src="/images/other/right.png"/>   {{$t('message.SaveOffline')}} </div>
          <div class="import-info">
             {{$t('message.Pleasedonotsavethe')}}
          </div>
          <div class="import-title"><img src="/images/other/right.png"/>   {{$t('message.SavebyPasswordManager')}}   </div>
            <div class="import-info">
             {{$t('message.Itisrecommendedto')}} 
          </div>
        </div>
        </van-dialog>
