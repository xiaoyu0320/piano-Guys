      ...
      <div class="list" v-if="showList" >
        ...
        <template v-if="type==3">
         ...
         <li  @click="goRightManger"><span><img src="/images/other/icon_jiaoyijilu@2x.png"/><label>{{$t('message.right')}}</label></span><span><img src="/images/other/arrow@2x.png" width="100%"/></span></li> 
          ...
          <li  @click="createAccount"><span><img src="/images/other/icon_wallet@2x.png"/><label>为他人创建EOS账户</label></span><span><img src="/images/other/arrow@2x.png" width="100%"/></span></li>
        </template>
       ...
       <div v-else class="special">
         <div class="eos" v-if="type==3">
             <van-cell-group>
                <van-cell title="角色" value="active" />
            <!--     <van-cell title="公钥" :value="list.active" /> -->
                <van-cell class="clipboard"  title="私钥" :value="copyName" @click="getCopy(list.pk,$event)" :data-clipboard-text="copyName" />
              </van-cell-group>
              <van-cell-group >
                <van-cell title="角色" value="owner" />
         ...
         <div class="BTC" v-else-if="title=='BTC'||title=='ETH'">
             <van-cell-group>
                ...
                <van-cell title="公钥" :value="list.account" />
                <van-cell class="clipboard"  title="私钥" :value="copyName" @click="getCopy(list.pk,$event)" :data-clipboard-text="copyName" />
              </van-cell-group>
       ...
       <div class="delWallet">
        ...
        <div style="padding:20px">
          <div class="import-title"> <img src="/images/other/error.png"/> 请勿截屏 </div>
          <div class="import-info">
            如果有人获取你的私钥将直接获取你的资产！
            请抄写下私钥并存放在安全的地方
          </div>
          <div class="import-title"> <img src="/images/other/error.png"/> 请勿使用网络传输 </div>
          <div class="import-info">
          请勿 使用QQ、微信、邮箱、等网络通讯工具传输私钥！
            请抄写下私钥并存放在安全的地方
          </div>
