...
<div class='invite ' ref="bodyHeight" style="padding-top:40px" >
    ...
    <div class="invite__box">
        <div class="invite__box--tabs">
            <div  class="heard-top"><span :class="{active:inviteActive==1}" @click="tabs(1)">{{$t('message.Invitation')}}</span><span :class="{active:inviteActive==2}" @click="tabs(2)">收益记录 </span></div>
        </div>
