        ...
        <van-popup v-model="showPop" position="right" >
         ...
         <div class="qrcode">
          ...
          <div class="qrcode-box "> 
            <span>{{$t("message.RecommendShare")}}</span>
             
            <p>{{invite_url}}</p>
            <div @click.stop="getCopy" class="copybutton copyBtn" :data-clipboard-text="invite_url">{{$t("message.copy")}}</div>
          </div>
...
import { setCookie,judgeLanguage } from '@/common/auth'
