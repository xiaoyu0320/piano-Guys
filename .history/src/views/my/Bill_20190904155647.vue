...
<div class='bill'  ref="bodyHeight" @touchstart="touchStart($event)" @touchmove="touchMove($event)" @touchend="touchEnd($event)" style=" background:url(https://wallet.ascchain.com/uploads/20190904/55acd655d5be65d7b7d43c954e70f217.png) no-repeat center;background-size: cover;">
     <van-nav-bar
    ...
    <van-action-sheet v-model="popupFlag" :actions="actions" cancel-text="取消" @select="onSelect"></van-action-sheet>
     ...
     <div class="bill__opearte">
        ...
        <van-button class="linear-button bill__btn copybutton" round size="small" @click="getCopy"  :data-clipboard-text="invite_url">{{$t('message.CopyLink')}}</van-button>
