...
<div class='bill'  ref="bodyHeight" @touchstart="touchStart($event)" @touchmove="touchMove($event)" @touchend="touchEnd($event)" style=" background:url(https://s2.j10kb.cn/uploads/20190904/55acd655d5be65d7b7d43c954e70f217.png) no-repeat center;background-size: cover;">
     <van-nav-bar
