    ...
    <div class="topbg">
      ...
      <div class="top" @click="goAccountManage">
        <div class="top-content">
          ...
          <div class="invite">
            <p>{{returnStaus()}}</p>
            <p style="font-size:12px;margin-top:5px">邀请码：{{userinfo.invite_code}}   <span @click.stop="getCopy" class="copybutton copyBtn" :data-clipboard-text="userinfo.invite_code" style="border:0"><img src="/images/other/mycopy.png" style="width:16px;position:relative;top:3px"/></span></p>
          </div>
          
          <div class="home-page">个人主页<img src="/images/other/right-icon.png" style="position:relative;right:-5px;width:7px"></div>
        </div>
      ...
      <ul class="list">
       <li @click="invite()">
          <div class="income">
            <h4>我的收益 <label>(邀请好友可获得邀请收益)</label></h4>
       ...
       <li style="margin-bottom:15px">
        ...
        <li  @click="gohelp()">
         ...
         <li  @click="goguide()">
          <span><img src="/images/other/guide.png"/>操作指南</span>
          <span><img src="/images/other/arrow@2x.png" width="100%"/></span>
        </li>
        <li  @click="goagement()">
...
export default {
  ...
  methods: {
     returnStaus(){
       console.log(this.userinfo.ascrole)
