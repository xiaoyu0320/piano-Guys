...
<div class='down' ref="bodyHeight" style=" background:url(../../images/down/down-bg.png) no-repeat center;background-size: contain;
    ...
    <div >
        ...
        <div class="down__btn--box">
            <button class="down__btn IOS"  style="margin-top:60px" @click="ios()"><img src="/images/down/down-iphone.png">IOS下载</button>
            <button class="down__btn" @click="down()" style="margin-top:25px;border-color:#3878ff;color:#127bff"><img src="/images/down/down-az.png">安卓下载</button>
        </div>
         <div class="bill__opearte">
            <van-button class="linear-button bill__btn bill__copy--btn copybutton" size="small" @click="getCopy"  :data-clipboard-text="copyUrl" ><img src="/images/down/copy.png" style="width:12px;position:relative;top:2px">复制下载地址</van-button>
         </div>
...
created() {
this.copyUrl = 'https://wallet.ascchain.com/?gourl=download&code='+localStorage['ref']
