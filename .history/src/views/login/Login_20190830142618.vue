<template>
  <div class="login">
  	<div class="logo-style"><img src="/images/login/logo.png" width="30%;"/></div>
      ...
      <div class="login__account" > {{$t("message.NewtoASCWALLET")}}<strong style="color:#3b80ff;font-size:12px;font-weight:0" @click="goregister"> {{$t("message.Register")}}</strong></div>
