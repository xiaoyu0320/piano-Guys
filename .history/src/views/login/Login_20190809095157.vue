<template>
  <div class="login">
  	...
  	<div class="title"><span @click="text()">区块链身份登录</span></div>
  	<div class="login-content">
  		<span><label>+86</label><input type="text" placeholder="请输入手机号码" v-model="phone"/></span>
  		<span><label><img src="/images/login/password.png" style="width:15px"></label><input type="password" placeholder="请输入登录密码" v-model="password" @keydown="submit($event)"/>
      <span class="login__forget"> <strong style="color:#3b80ff" @click="goforget">忘记密码？</strong></span>
      ...
      <div class="login__account"> 还没有账号？<strong style="color:#3b80ff;font-size:12px;font-weight:0" @click="goregister">去注册</strong></div>
       
       <span class="btn linear-button" @click="_login">登录</span>
