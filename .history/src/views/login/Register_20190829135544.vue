  ...
  <div class="register">
    <div class="heard">
      ...
      <h4 class="login-title"> {{$t("message.Register")}}</h4>
  		<span><label><img src="/images/login/re-phone.png"/></label><label>{{areaCode}}</label><input type="text"  v-model="mobile" @input="onIpunt" :placeholder="$t('message.Pleaseenteryourphonenumber')" /></span>
